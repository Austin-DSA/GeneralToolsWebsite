...
class EmailAccount:
    ...
    def sendMessage(self, toAddress: str, subject: str, messageText: str, attachments:list[Attachement] = []):
...
def _websiteEmailAccount() -> EmailAccount:
    return EmailAccount(username=SecretManager.getWebsiteEmailAccountUserName(), password=SecretManager.getWebsiteEmailAccountPassword())

def sendEmailFromWebsiteAccount(toAddress: str, subject: str, messageText: str, attachments:list[Attachement] = []) -> None:
    sendingAccount = _websiteEmailAccount()
    sendingAccount.sendMessage(toAddress=toAddress, subject=subject, messageText=messageText, attachments=attachments)